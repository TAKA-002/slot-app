...
export default function SlotContainer({
  ...
  return (
    <div
      className="grid place-items-center py-20 bg-slot-pattern"
      style={{
    ...
    >
      ...
      <p
        className="w-120 mt-24 py-2 px-12 border-4 border-[#A89B84] rounded-[8px] shadow-md text-xl text-[#4D3D30] font-bold"
